                    ...
                    if selectEvents == "" {
                        Button {
                            ...
                            HStack(alignment: .center, spacing: 0) {
                                ...
                                Image(systemName: "chevron.down")
                                    ...
                                    .padding(.leading, 5)
                                    // .foregroundColor(is121 ? Color(red: 0.89, green: 0.17, blue: 0.3) : Color.black)
                            }
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 8)
                                    .inset(by: 0.5)
                                    .stroke(is121 ? Color(red: 0.89, green: 0.17, blue: 0.3) : Color.black, lineWidth: Constants.StrokeBorder)
                            )
                            .padding(.trailing, 10)
                        ...
                        Button {
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 8)
                                    .inset(by: 0.5)
                                    .stroke(isEvent ? Color(red: 0.89, green: 0.17, blue: 0.3) : Color.black, lineWidth: Constants.StrokeBorder)
                            )
                            .padding(.trailing, 10)
